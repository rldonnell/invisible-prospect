...
export const CLIENT_TAXONOMIES = {
  "sa-spine": {
    ...
    rules: [
      // Conditions
      { pattern: "cervical-lordosis", category: "Conditions", subcategory: "Cervical Lordosis" },
      ...
      // Providers
      { pattern: "steven-j-cyr", category: "Provider Research", subcategory: "Dr. Steven J. Cyr" },
      { pattern: "dr-cyr", category: "Provider Research", subcategory: "Dr. Steven J. Cyr" },
      { pattern: "our-team", category: "Provider Research", subcategory: "Team Page" },
      { pattern: "spine-center", category: "Provider Research", subcategory: "Spine Center" },
      // High Intent
